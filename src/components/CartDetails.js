                                    ...
                                    <table className='table cart-table mb-0 table-responsive-sm'>
                                                    ...
                                                    return (
                                                        <>
                                                            <tr>
                                                                ...
                                                                <td className='text-right'> zł {data.qnty * data.price}</td>
                                                            </tr>
                                                        </>
                                                    )
                                                })
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th className='text-right'>Total Price<span className='ml-2 mr-2'>:</span><span className='text-danger'> zł {totalprice}</span></th>
                                            </tr>
                                        </tfoot>
                                    </table>
                                }
